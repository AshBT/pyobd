...
You can get Windows drivers for your USB ELM327 on this site: http://www.totalcardiagnostics.com/support/Knowledgebase/Article/View/1/0/how-to-install-elm327-usb-cable-on-windows-and-obd2-software
...
The engine must be running before connecting, for the program to connect and display all the sensor data. It also will connect if the engine is not running but the ignition must be on. But without ignition on, the program will not connect to the ECU at all.
